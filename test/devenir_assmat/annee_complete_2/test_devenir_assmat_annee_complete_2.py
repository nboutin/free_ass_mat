...
class TestDevenirAssmatAnneeComplete2(unittest.TestCase):
    ...
    def test_calcul_annee_complete(self):
        ...
        self.assertEqual(self.planning.semaines.get_jours_travailles(0), 5)
        self.assertEqual(self.planning.semaines.get_jours_travailles(1), 4)
        self.assertEqual(self.planning.semaines.get_heures_travaillees(0), 40)
        self.assertEqual(self.planning.semaines.get_heures_travaillees(1), 32)
