...
class Contract:
    ...
    def get_salaire_net_mois_par_date(self, date: datetime.date) -> float:
        ...
        return salaire_net_mensualise \
            ...
            + self._garde.get_heures_complementaires_mois_par_date(date) * self._salaires.horaire_complementaires \
            + self._garde.get_heures_majorees_mois_par_date(date) * self._salaires.horaire_majorees
