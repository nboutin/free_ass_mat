...
class Garde:
    ...
    def get_heures_complementaires_semaine_par_date(self, year: int, numero_semaine: int) -> float:
    ...
    def get_heures_majorees_semaine_par_date(self, year: int, numero_semaine: int) -> float:
        ...
        h_comp_semaine = self.get_heures_complementaires_semaine_par_date(year, numero_semaine)
