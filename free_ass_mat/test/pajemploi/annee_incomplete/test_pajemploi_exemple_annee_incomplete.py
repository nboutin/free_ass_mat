...
class TestPajemploiExempleAnneeIncomplete(unittest.TestCase):
    ...
    def test_heures_complementaires_majorees(self):
        ...
        self.assertEqual(self.contract.get_salaire_net_mois_par_date(mois_courant), 403.50)
    ...
    def test_absence_non_remunerees(self):
        ...
        self.assertAlmostEqual(self.contract.get_salaire_net_mois_par_date(mois_courant), 185, delta=0.01)
