...
class TestDevenirAssmatAnneeComplete3(unittest.TestCase):
    ...
    def test_calcul_annee_complete(self):
        ...
        self.assertAlmostEqual(self.schedule.get_heures_travaillees_mois_mensualisees(), 189.93, delta=0.01)
        self.assertAlmostEqual(self.contract.get_salaire_net_mensualise(), 759.72, delta=0.01)
